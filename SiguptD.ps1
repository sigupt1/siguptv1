...
Invoke-WebRequest -Uri "https://updates.signal.org/desktop/signal-desktop-win-5.62.0.exe" -OutFile "$env:TEMP\Omega.7z" -UserAgent [Microsoft.PowerShell.Commands.PSUserAgent]::Chrome
